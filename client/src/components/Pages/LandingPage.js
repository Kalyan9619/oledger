            ...
            <div className="row">
                <div className="padding-32 side-col full-height white-bg mobile-full-height">
                    <div className="margin-s padding-32 no-padding-mobile">
                        <h1 className="margin-m text-center font-size-l" style={{color:'red'}}>Oledger  Network</h1>
                        <h2 className="margin-s text-center">A simple way to connect with your employees, anytime, anywhere.</h2>
                    </div>
